...
import com.edu.service.mapper.CourseMapper;
...
public class CourseResourceIntTest {
    ...
    public void createCourse() throws Exception {
        ...
        assertThat(testCourse.getModDate()).isEqualTo(DEFAULT_MOD_DATE);
        assertThat(testCourse.getFee()).isEqualTo(DEFAULT_FEE);
        assertThat(testCourse.getDurationYear()).isEqualTo(DEFAULT_DURATION_YEAR);
        assertThat(testCourse.getDurationMonth()).isEqualTo(DEFAULT_DURATION_MONTH);
        assertThat(testCourse.getDurationDay()).isEqualTo(DEFAULT_DURATION_DAY);
    }
    ...
    public void updateCourse() throws Exception {
        ...
        assertThat(testCourse.getModDate()).isEqualTo(UPDATED_MOD_DATE);
        assertThat(testCourse.getFee()).isEqualTo(UPDATED_FEE);
        assertThat(testCourse.getDurationYear()).isEqualTo(UPDATED_DURATION_YEAR);
        assertThat(testCourse.getDurationMonth()).isEqualTo(UPDATED_DURATION_MONTH);
        assertThat(testCourse.getDurationDay()).isEqualTo(UPDATED_DURATION_DAY);
    }
