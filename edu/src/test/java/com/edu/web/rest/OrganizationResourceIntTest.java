...
public class OrganizationResourceIntTest {
    ...
    public void createOrganization() throws Exception {
        ...
        assertThat(testOrganization.getAccountStatus()).isEqualTo(DEFAULT_ACCOUNT_STATUS);
        assertThat(testOrganization.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
        assertThat(testOrganization.getModDate()).isEqualTo(DEFAULT_MOD_DATE);
    }
    ...
    public void updateOrganization() throws Exception {
        ...
        assertThat(testOrganization.getAccountStatus()).isEqualTo(UPDATED_ACCOUNT_STATUS);
        assertThat(testOrganization.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
        assertThat(testOrganization.getModDate()).isEqualTo(UPDATED_MOD_DATE);
    }
